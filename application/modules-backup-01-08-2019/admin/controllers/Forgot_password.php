...
class Forgot_password extends CI_Controller {
	...
	public function retrieve_password()
	{
		if($_POST) {
			...
			{
				$finalResult = array('msg' => 'error', 'response'=> strip_tags(validation_errors()));
				...
				if($status){
					...
					$finalResult = array('msg' => 'success', 'response'=>'Password has been successfully sent to your email address!');
					echo json_encode($finalResult);
					exit;
				} else {
	...
	public function email_exist($email)
	{
		...
		{
			$this->form_validation->set_message('email_exist', "Email doesn't exist.");
			return FALSE;
		}
	}
