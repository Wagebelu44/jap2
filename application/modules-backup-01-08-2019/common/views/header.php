...
<head>
    ...
    <title>JAP - We Lead, They Follow</title>
...
<body>
<!-- 	<?php
		//define('BASE_URL', 'http://localhost/just-another-panel');
	?> -->
    <!--[if lt IE 8]>
        ...
        <div class="header-area h-style5">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-12 d-block d-lg-none mobile_navs p-0" id="mobile_navs">
