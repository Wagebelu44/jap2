...
<tr>
    <td class="table-row-td" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; padding-left: 36px; padding-right: 36px;" valign="top" align="left">
        <table class="table-col" align="left" width="478" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;">
            <tbody>
                <tr>
                    <td colspan="2" class="table-col-td" width="478" style="font-family: Arial, sans-serif; line-height: 19px; padding-top: 15px; color: #444444; font-size: 13px; font-weight: normal; width: 478px;" valign="top" align="left">
                ...
                <tr>
                    <td width="50%">
                        ...
                        <span> <b> Dear <?php echo $first_name;?>, </b></span><br>
                    </p>
                    <p style="color:#444444">
                        <span> <b> Your Order Number is: <br><span style="color:#f05327; font-size: medium;"><?php echo $payment_id;?></span></b></span><br>
                    </p>
                    
                    <p style="color:#444444">
                        <span> <b> Your Gift Card Voucher Code is: <br><span style="color:#f05327; font-size: medium;"><?php echo $voucher_code;?></span></b></span><br>
                    </p>
                    
                    
                    <p style="color:#444444">
                        Thank you for visiting us and making us your first choice. We look forward to seeing you again. Have a great day!.
                    </p>
                    ...
                    <td width="50%" align="center">
                        <img src="<?php echo base_url(); ?>/assets/images/<?php echo $card_image;?>.png" style='width: 152px;background:transparent;float: right;'>
                    </td>
                </tr>
            </tbody>
        </table>
...
<tr>
    <td width="100%" align="center" bgcolor="#f5f5f5" style="font-family: Arial, sans-serif; line-height: 24px; color: #bbbbbb; font-size: 13px; font-weight: normal; text-align: center; padding: 9px; border-width: 1px 0px 0px; border-style: solid; border-color: #e3e3e3; background-color: #092b64;" valign="top">
