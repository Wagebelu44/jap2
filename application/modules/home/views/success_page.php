...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            ...
            <h2 style="color:#0fad00">Thank You</h2>
            <p style="font-size:20px;color:#5C5C5C;">You have purchased a gift card successfully. Your order number is: <?php echo $payment_id;?>.
                <br>The gift code has been sent to you by the provided email.
            </p>
            <a href="<?php echo base_url()?>home" class="btn btn-success">Back to Home</a>
